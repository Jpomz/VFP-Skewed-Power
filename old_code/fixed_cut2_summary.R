...
results <- readRDS("simulation_results/fixed_cut2_sim_run.rds")
...
ggsave("plots/lambda_fixed_cut2_minimal.png",
       units = "in",
       height = 6,
       width = 10)
...
results |>
  ...
  labs(x = "\u03bb estimate",
       y = "density",
       title = "Moderate Bias")
ggsave("plots/lambda_fixed_cut2_moderate.png",
       units = "in",
       height = 6,
       width = 10)
...
results |>
  ...
  labs(x = "\u03bb estimate",
       y = "density",
       title = "Strong Bias")
ggsave("plots/lambda_fixed_cut2_strong.png",
       units = "in",
       height = 6,
       width = 10)
results |>
  ...
  labs(x = "\u03bb estimate",
       y = "density",
       title = "Extreme Bias")
ggsave("plots/lambda_fixed_cut2_extreme.png",
       units = "in",
       height = 6,
       width = 10)
...
ggsave("plots/rep_lines_fixed2_extreme_MS.png",
       units = "in",
       height = 6,
       width = 10)
...
ggsave("plots/rep_lines_fixed2_minimal_MS.png",
       units = "in",
       height = 6,
       width = 10)
...
lm_models |>
  ...
  labs(title = "Minimal Bias",
       x = "beta estimate")
ggsave("plots/beta_fixed2_minimal_MS.png",
       units = "in",
       height = 6,
       width = 10)
...
lm_models |>
  ...
  labs(title = "Extreme Bias",
       x = "beta estimate")
ggsave("plots/beta_fixed2_extreme_MS.png",
       units = "in",
       height = 6,
       width = 10)
...
lm_models |>
  ...
  labs(title = "Moderate Bias",
       x = "beta estimate")
ggsave("plots/beta_fixed2_moderate_MS.png",
       units = "in",
       height = 6,
       width = 10)
...
lm_models |>
  ...
  labs(title = "Strong Bias",
       x = "beta estimate")
ggsave("plots/beta_fixed2_strong_MS.png",
       units = "in",
       height = 6,
       width = 10)
...
beta_bias <- lm_table_dat |> 
  ...
  arrange(cutoff,
          ...
          data_model) 
write_csv(beta_bias, 
          "simulation_summaries/beta_bias_table_fixed2_cutoff.csv")
