...
saveRDS(run, paste0("simulation_results/fixed_cut2_run_time_s_", Sys.Date(), ".rds"))

# results
saveRDS(results, "simulation_results/fixed_cut2_sim_run.rds")

# remove Rplots? ####
# test this before enacting
