...
saveRDS(run, paste0("simulation_results/gradient_run2_time_s_", Sys.Date(), ".rds"))

# results
saveRDS(results, "simulation_results/gradient_sim_run2.rds")
