# these are old custom functions which are not implemented in the current version of the manuscript
# sample_pr ####
...
# function to "back-calculate" abundance of individual lenghts based on the inverse of their retention probability. 
# This is taked from Morin et al. 2004 but is not currently implemented
